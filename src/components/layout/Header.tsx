...
const activeClass = 'text-brand-700 bg-brand-100 font-semibold shadow-sm dark:text-brand-300 dark:bg-brand-900/50 dark:shadow-brand-900/20'
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `block rounded-lg px-4 py-2.5 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-500/30 ${
                  isActive
                    ? 'bg-brand-100 text-brand-700 shadow-sm dark:bg-brand-900/50 dark:text-brand-300 dark:shadow-brand-900/20'
