      ...
      >
        ...
        <div className="relative space-y-6">
          ...
          >
            ...
            <ClockIcon className="relative z-10 h-4 w-4 animate-pulse transition-transform duration-300 group-hover/badge:rotate-12" />
            <span className="relative z-10">{language === 'fr' ? 'Services' : 'Services'}</span>
          </div>
